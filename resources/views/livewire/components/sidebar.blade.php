...
{{-- TODO: When you create sidebar as livewire component use @teleport blade directive --}}
    ...
    class="fixed inset-y-0 left-[70px] w-96 px-4 overflow-y-scroll overflow-x-hidden shadow bg-white border rounded-r-2xl z-[50]">
        ...
        <template x-if="showSearch">
            <div x-cloak class="h-full">
                <header class="sticky top-0 w-full z-10 bg-white py-2">
                    ...
                    <input wire:model.live="query" type="search" class="border-0 outline-none w-full focus:outline-none bg-gray-100 rounded-lg hover:ring-0 focus:ring-0 placeholder-search">
                </header>
                    ...
                    <ul class="space-y-2 overflow-x-hidden">
                        ...
                        <li>
                            <a href="{{route('profile.home', $user->username)}}" class="flex gap-2 truncate items-center">
                                <x-avatar wire:ignore class="w-9 h-9 mb-auto" src="https://source.unsplash.com/500x500?face{{$key}}"></x-avatar>
        ...
        <div x-cloak x-if='showNotifications'>
            <livewire:components.notifications></livewire:components.notifications>
        </div>
