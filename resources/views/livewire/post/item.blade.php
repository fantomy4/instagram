<div class="max-w-lg mx-auto">
    ...
    <header class="flex items-center gap-3">
        <x-avatar src="https://source.unsplash.com/500x500?face" class="h-9 w-9 /"></x-avatar>
        ...
        <div class="my-2">
            ...
            " class="swiper h-[500px] border bg-white">
                ...
                <div class="swiper-wrapper">
                    <!-- Slides -->
                    <div class="swiper-slide"><x-video></x-video></div>
                    <div class="swiper-slide"><img src="https://cdn.pixabay.com/photo/2017/08/13/08/22/balloon-2636520_1280.jpg" alt="" class="h-[500px] w-full block object-scale-down"></div>
                    <div class="swiper-slide"><img src="https://cdn.pixabay.com/photo/2021/01/06/12/14/church-5894267_1280.jpg" alt="" class="h-[500px] w-full block object-scale-down"></div>
                    ...
                </div>
    ...
    <footer>
        ...
        <div class="flex text-sm gap-2 font-medium">
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores, est alias! Saepe, ea a inventore accusantium architecto magni impedit expedita rerum, sapiente molestias rem nisi quo vitae ab mollitia. Unde!
            </p>
        </div>
        ...
        <form x-data="{inputText:''}" class="grid grid-cols-12 items-center w-full">
            ...
            <input x-model="inputText" type="text" placeholder="Leave a comment" class="border-0 col-span-10 placeholder:text-sm outline-none focus:outline-none px0 rounded-lg hover:ring-0 focus:ring-0">
