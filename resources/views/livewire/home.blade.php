    ...
    <header class="md:hidden sticky top-0 bg-white">
        ...
        <div class="grid grid-cols-12 gap-2 items-center">
            ...
            <div class="col-span-3">
                <img class="h-12 max-w-lg w-full" src="{{asset('assets/logo.png')}}" alt="logo">
            </div>
    ...
    <main class="grid lg:grid-cols-12 gap-8 md:mt-10">
        ...
        <aside class="lg:col-span-4 hidden lg:block p-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <x-avatar src="https://source.unsplash.com/500x500?face" class="w-12 h-12"></x-avatar>
            ...
            <section class="mt-4">
                ...
                <ul class="my-2 space-y-3">
                    ...
                    <li class="flex items-center gap-3">
                        <x-avatar src="https://source.unsplash.com/500x500?face-{{$i}}" class="w-12 h-12"></x-avatar>
            ...
            <section class="mt-5">
                ...
                <h3 class="text-gray-800/90 mt-6 text-sm"> @ 2024 INSTAGRAM</h3>
            </section>
